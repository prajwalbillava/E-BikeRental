...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.ModelYear,tblvehicles.Registration,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>
										<tr>
											...
											<td><?php echo htmlentities($result->PricePerDay);?></td>
												...
												<td><?php echo htmlentities($result->Registration);?></td>
