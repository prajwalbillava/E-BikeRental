...
$msg="Testimonial Successfully Inarchived.";
}
...
<head>
	...
	<title>Bike Rental Portal |Admin Manage Feedback   </title>
...
<?php  ?></td>
<td><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to approve this testimonial..!')"> Inarchive</a> /


<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this testimonial')">Archive</a>
</td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
