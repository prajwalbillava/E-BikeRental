    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <h3>E-BIKE RENTAL</h2> </div>
        </div>
...
<?php }
  ...
  echo "<p style='text-align:right; color:black; font-size:20px; font-weight:bold;'>Welcome To E-Bike Rental</p>";
} ?>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="search-carresult.php">Bike Listing</a></li>
