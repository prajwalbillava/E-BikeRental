...
$city=$_POST['city'];
//$license=$_FILES["img1"]["license"];
//$aadhaar=$_FILES["img2"]["aadhaar"];
...
//$query->bindParam(':aadhaar',$license,PDO::PARAM_STR);
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/face.jpeg" alt="image">
      </div>
      ...
      <div class="dealer_info">
        ...
        <p><?php echo htmlentities($result->Address);?><br>
          ...
          <?php echo htmlentities($result->License);?>
        </p>
      </div>
    </div>
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="mobilenumber" value="<?php echo htmlentities($result->ContactNo);?>" id="phone-number" type="tele" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Aadhaar ID</label>
