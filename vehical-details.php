...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post" action="paymentf.php?id=<?php echo htmlentities($result->PricePerDay);?> ">
            <div class="form-group">
              <input type="hidden" name="idv" value="<?php echo htmlentities($result->id);?>">
              <input type="hidden" name="idn" value="<?php echo $_SESSION['login'];?>">
              <input type="hidden" name="status" value="<?php echo $status;?>">
              <input type="date" class="form-control" name="fromdate" placeholder="From Date" required id="fromdate">
<input type="date" class="form-control" name="todate" placeholder="To Date" required id="todate">

<script>
  // Get the "fromdate" and "todate" input elements
  ...
  // Add an event listener to the "fromdate" input element
  fromDateInput.addEventListener("change", function() {
    // Update the "min" attribute of the "todate" input element
  ...
  I have read the <a href="page.php?type=terms">terms and conditions</a>
</label>
...
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
              ...
              <?php } ?>
              <script>
  // Disable the submit button until the terms and conditions checkbox is checked
          ...
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> seats</li>
                ...
                <li><i class="fa fa-cogs" aria-hidden="true"></i><?php echo htmlentities($result->FuelType);?></li>
              </ul>
            </div>
          </div>
        </div>
